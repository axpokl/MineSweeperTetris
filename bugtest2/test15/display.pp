...
writeln(2,r,#9,geterror(),#9,_hw:10,#9,_mst.hwnd:10,#9,_mst.message:10,#9,_mst.wparam:10,#9,_mst.lparam:10,#9,_mst.time);
  if (r>0) and (longint(_mst.message)<>32767) then SendMsg();
