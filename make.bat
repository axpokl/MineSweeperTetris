...
g++ -Wall -static -Os -s main.cpp icon.res -o MineSweeperTetris.exe -lwinmm -lgdiplus -lgdi32 -lmsimg32 -lsteam_api -mwindows
g++ -Wall -static -Os -g main.cpp icon.res -o MineSweeperTetris_debug.exe -lwinmm -lgdiplus -lgdi32 -lmsimg32 -lsteam_api -mwindows
