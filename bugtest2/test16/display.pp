...
begin
writeln(4,#9,geterror(),#9,_hw:10,#9,hw:10,#9,um:10,#9,wp:10,#9,lp:10);
WndProc:=0;
case uM of
  WM_CREATE:
    begin
...
writeln(5,#9,geterror(),#9,_hw:10,#9,hw:10,#9,um:10,#9,wp:10,#9,lp:10);
end;
...
while IsWin() do
  begin
writeln(1,#9,geterror(),#9,_hw:10,#9,_mst.hwnd:10,#9,_mst.message:10,#9,_mst.wparam:10,#9,_mst.lparam:10,#9,_mst.time);
if (longint(PeekMessage(_mst,0,0,0,PM_REMOVE))>0) then
begin
//  r:=longint(GetMessage(_mst,0,0,0));
writeln(2,#9,geterror(),#9,_hw:10,#9,_mst.hwnd:10,#9,_mst.message:10,#9,_mst.wparam:10,#9,_mst.lparam:10,#9,_mst.time);
  if (longint(_mst.message)<>32767) then SendMsg();
writeln(3,#9,geterror(),#9,_hw:10,#9,_mst.hwnd:10,#9,_mst.message:10,#9,_mst.wparam:10,#9,_mst.lparam:10,#9,_mst.time);
