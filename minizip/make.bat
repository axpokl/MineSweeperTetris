...
mingw32\bin\g++ -Wall -static -Os -s main.cpp icon32.res -o MineSweeperTetris_32.exe -lwinmm -lgdiplus -lgdi32 -lmsimg32 -lsteam_api -Iinclude -Llib -lminizip -lz-ng -llzma -lzstd -lbzip2 -mwindows
